...
class AgcAdjustedScrotalCircumferenceProgress {
    constructor() {
        this.socket = "";
        this.currentStep = -1;
    }
    ...
    static get is() { return "agc-adjusted-scrotal-circumference-progress"; }
...
export { AgcAdjustedScrotalCircumferenceProgress };
